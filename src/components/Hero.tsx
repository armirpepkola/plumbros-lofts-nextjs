        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 min-h-[80vh]">
          ...
          <div className="flex flex-col justify-center text-white p-8 md:p-12 text-center lg:text-left z-10">
            <motion.div variants={textContainerVariants} initial="hidden" animate="visible">
              <motion.h1 className="text-5xl md:text-6xl font-extrabold font-[var(--font-montserrat)] mb-6 leading-tight" variants={textItemVariants}>
              ...
              <motion.div variants={textItemVariants}>
                ...
                >
                  <Link 
                    href="/contact" 
                    className="relative inline-flex items-center overflow-hidden bg-[var(--color-brand-primary)] text-white font-bold font-[var(--font-montserrat)] uppercase py-4 px-10 rounded-md shadow-lg transition-shadow duration-300"
                  >
                    <motion.span
          ...
          <div className="relative hidden lg:block">
            ...
            <motion.div className="absolute inset-0 z-10" style={{ scale: scale }}>
              <Image src="/homepage/hero-background.jpg" alt="A beautifully finished loft conversion project" fill className="object-cover" priority />
            </motion.div>
          </div>
        </div>
      </div>
